        ...
        child: Row(
          ...
          children: <Widget>[
            CircularPercentIndicator(
                ...
                lineWidth: 25.0,
                percent: (pill.obtPorcentajeMedicacion(0)/100),
                center: Text(
                  '${pill.obtPorcentajeMedicacion(0)}%',
                  style: GoogleFonts.montserrat(
                    fontSize: 20.0,
                    fontWeight: FontWeight.bold
                  ),
...
/*class homePage extends StatelessWidget {
  ...
  initState(){
    ...
    //final currentCount = prefs.getInt(countKey) ?? 0;
      final medicacion = MyPill(_modelMedicamto.medicamentos);
            medicacion.proximaToma();
      /*if(currentCount == 0){//No cuenta con notificaciones
        //CREAR NOTIFICACIONES
        //USO DE ALARM MANAGER 
